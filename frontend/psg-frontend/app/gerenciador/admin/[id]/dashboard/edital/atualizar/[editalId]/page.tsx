...
export default function UpdateEditalPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            formData.append('title', edital.title || '');
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black text-[#f58220] tracking-tight">Editar Edital</h1>
                    <p className="text-slate-500 font-medium">{edital?.title}</p>
                </div>
            </div>
