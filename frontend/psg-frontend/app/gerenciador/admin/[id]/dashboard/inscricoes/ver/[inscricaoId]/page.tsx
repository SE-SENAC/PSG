...
import { ArrowLeft, Users, Loader, Mail, Phone, FileText, Book } from 'lucide-react';
                    ...
                    <Card className="rounded-[40px] border-none shadow-2xl shadow-slate-200/50 overflow-hidden sticky top-6">
                        ...
                        <CardContent className="p-10 space-y-4">
                            <Button 
                                ...
                                onClick={() => router.push(`/gerenciador/admin/${params.id}/dashboard/inscricoes/atualizar/${inscricaoId}`)}
                            >
                                Editar
                            </Button>
                            <Button 
